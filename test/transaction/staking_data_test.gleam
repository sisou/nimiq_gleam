...
import transaction/staking_data.{
  AddStake, CreateStaker, CreateValidator, DeactivateValidator,
  ReactivateValidator, RetireValidator, UpdateStaker, UpdateValidator,
}
import utils/misc
...
pub fn deactivate_validator_serialization_test() {
  ...
  let serialized =
    DeactivateValidator(address, signature_proof)
    |> staking_data.serialize_to_bits()
  ...
  let assert Ok(DeactivateValidator(validator_address, proof)) =
    staking_data.deserialize_all(serialized)
...
pub fn reactivate_validator_serialization_test() {
  ...
  let serialized =
    ReactivateValidator(address, signature_proof)
    |> staking_data.serialize_to_bits()
  ...
  let assert Ok(ReactivateValidator(validator_address, proof)) =
    staking_data.deserialize_all(serialized)
...
pub fn retire_validator_serialization_test() {
  ...
  let serialized =
    RetireValidator(signature_proof)
    |> staking_data.serialize_to_bits()
  ...
  let assert Ok(RetireValidator(proof)) =
    staking_data.deserialize_all(serialized)
...
pub fn create_staker_serialization_test() {
  ...
  let serialized =
    CreateStaker(Some(address), signature_proof)
    |> staking_data.serialize_to_bits()
  ...
  let assert Ok(CreateStaker(delegation, proof)) =
    staking_data.deserialize_all(serialized)
...
pub fn add_stake_serialization_test() {
  ...
  let assert Ok(AddStake(staker_address)) =
    staking_data.deserialize_all(serialized)
...
pub fn update_staker_serialization_test() {
  ...
  let serialized =
    UpdateStaker(None, False, signature_proof)
    |> staking_data.serialize_to_bits()
  ...
  let assert Ok(UpdateStaker(new_delegation, reactivate_all_stake, proof)) =
    staking_data.deserialize_all(serialized)
